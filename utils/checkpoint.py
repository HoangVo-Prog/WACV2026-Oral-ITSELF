...
class Checkpointer:
    ...
    def _prototype_config(self, branch, memory):
        return {
            ...
            "no_ira": getattr(branch, "no_ira", getattr(getattr(branch, "args", None), "no_ira", None)),
            "no_ira_mode": getattr(branch, "no_ira_mode", getattr(getattr(branch, "args", None), "no_ira_mode", None)),
            "assignment_mode": getattr(branch, "assignment_mode", getattr(memory, "assignment_mode", None)),
            "no_iopm": getattr(branch, "no_iopm", getattr(getattr(branch, "args", None), "no_iopm", None)),
