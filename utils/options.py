...
def get_args():
    ...
    parser.add_argument("--prototype_hard_k_mode", type=str, default="fixed", choices=["fixed", "calibrated"],
                        help="Use fixed prototype_hard_k or DMB-calibrated adaptive hard-negative scheduling.")
